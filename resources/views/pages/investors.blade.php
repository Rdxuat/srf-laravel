                        ...
                        <div class="stakeTabBody">
                            <div class="invest-bg newBg">
                                ...
                                <!-- <div class="col-md-12">
                                    <div class="pdfImg">
                                        <div class="icImg">
                                            <img src="images/invest/digital-report-img.webp"
                                                class="img-responsive" alt="">
                                        </div>
                                        <div class="twoBtn">
                                            <a href="">
                                                <div class="firstBtn">
                                                    <button>Digital Report</button>
                                                </div>
                                            </a>
                                            <a href="">
                                                <div class="firstBtn">
                    ...
                    <div class="tab-pane fade" id="in-tab-b" role="tabpanel" aria-labelledby="in-tab-2">
                        <div class="stakeTabBody">
                            <div class="invest-bg newBg">
                                ...
                                <!-- <div class="col-md-7">
                                    <div class="addresStock">
                                        <h3>Name and Address of Stock Exchange</h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisici elit…’ (complete
                                ...
                                <!-- <div class="col-md-7">
                                    <div class="addresStock" id="stock-chart">
                                        <h3>Name and Address of Stock Exchange</h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Provident,
                                            dolorum velit exercitationem ratione sequi impedit, molestias
                                            veritatis dolore, inventore aperiam sunt sed veniam voluptates.
                                            Nisi, blanditiis deleniti autem a architecto, in, sunt et debitis
                                            nam odio aut omnis. Molestiae quaerat consectetur error veniam est
                                            in voluptate dolorem vel iusto vitae.</p>
                                    </div>
                                    </div>
                                    <div class="col-md-5">
                                    <div class="addresStock">
                            ...
                            <div class="invest-bg newBg">
                                ...
                                <div class="col-md-12">
                                    <div class="credit-rating">
                                        <!-- <h2 class="credit-title">Credit Ratings</h2>
                                            <p class="credit-subtitle">
                                                A picture of stability and trust. Find more information on our
                                                credit rating.
                                            </p> -->
                                ...
                                <!-- <div class="mainBrown investor-content" id="regulation30">
                                </div> -->
                                <div class="row investor-content" id="dematerialisation">
                                <!-- <div class="col-md-3">
                                    <div class="fourCol">
                                        <div class="firstCol">
                                            <h3>Ashish Bharat Ram</h3>
                                            <p>Chairman & Managing Director</p>
                                            <p>222222-333333</p>
                                            <p>shares@dummy.com</p>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="col-md-12">
                                    <div class="tech">
                                        ...
                                        <h3>Technologies Limited</h3>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="tech">
                                
                                        <p><span>Address:</span> Lorem ipsum dolor sit amet, consectetur
                                            ...
                                            example, in</p>
                                        <p><span>Tel. No.:</span> +91 224 242 2411</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="tech fax">
                                        ...
                                        <h3>Toll Free No.: ----------------------</h3>
                                        <h3>Website: ----------------------</h3>
                                        <h3>Investor Grievance Email: ---------</h3>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="tech fax">
                                ...
                                <div class="col-md-12">
                                    <div class="tech">
                                        ...
                                        <p><span>Address:</span> Lorem ipsum dolor sit amet, consectetur
                                            adipisici
                                            elit…’ (complete text) is dummy text that is not meant to mean
                                            anything.
                                            It is used as a placeholder in magazine layouts, for example, in</p>
                                    </div>
                                </div>
                                </div>
                                <div class="row tight">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="email" class="form-control input-pill"
                                            placeholder="Your Name*">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control input-pill"
                                ...
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control input-pill" placeholder="Phone*">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="email" class="form-control input-pill"
                                            placeholder="Name of the sole/First holder*">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="fax">
                                <p>Enter either Folio Number or DP Number, Client ID</p>
                                </div>
                                <div class="row tight">
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control input-pill" placeholder="Email*">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="office-content" id="overview" style="display:block;">
                                        <p>The Company is of the belief that sound Corporate Governance is vital
                                            ...
                                            conduct of its business internally and externally.
                                        </p>
                                ...
                                <div class="office-content" id="bod" style="display:none;">
                                    <div class="myBod">
                                        <div class="col-md-12">
                                            ...
                                            <!-- <div class="brandStoriesSlider">
                                                <div class="swiper">
                                                    <div class="swiper-wrapper">
                                                        <div class="swiper-slide"><img
                                                                src="images/invest/bod-img1.webp"
                                                                class="img-responsive" alt="">
                                                            <div class="nameData">
                                                                <h3>Ashish Bharat Ram</h3>
                                                                <p>Chairman & Managing Director</p>
                                                        ...
                                                        <div class="swiper-slide"><img
                                                                src="images/invest/bod-img2.webp"
                                                                class="img-responsive" alt="">
                                                            <div class="nameData">
                                                                <h3>Kartik Bharat Ram</h3>
                                                                <p>Joint Managing Director</p>
                                                            </div>
                                                            <div class="btmDiv"></div>
                                                        </div>
                                                        <div class="swiper-slide"><img
                                                                src="images/invest/bod-img3.webp"
                                                                class="img-responsive" alt="">
                                                            <div class="nameData">
                                                                <h3>Vellayan Subbiah</h3>
                                                                <p>Non-Executive, Non-Independent
                                                                    Director
                                                                </p>
                                                            </div>
                                                            <div class="btmDiv"></div>
                                                        ...
                                                        <div class="swiper-slide"><img
                                                                src="images/invest/bod-img4.webp"
                                                                class="img-responsive" alt="">
                                                            <div class="nameData">
                                                                <h3>Vineet Agarwal</h3>
                                                                <p>Independent Director</p>
                                                            </div>
                                                            <div class="btmDiv"></div>
                                                        </div>
                                                        <div class="swiper-slide"><img
                                                                src="images/invest/bod-img5.webp"
                                                                class="img-responsive" alt="">
                                                            <div class="nameData">
                                                                <h3>Ira Gupta</h3>
                                                                <p>Independent Director</p>
                                                        ...
                                                        <div class="swiper-slide"><img
                                                                src="images/invest/bod-img6.webp"
                                                                class="img-responsive" alt="">
                                                            <div class="nameData">
                                                                <h3>Bharti Gupta Ramola</h3>
                                                                <p>Independent Director</p>
                                                            </div>
                                                            <div class="btmDiv"></div>
                                                        </div>
                                                        <div class="swiper-slide"><img
                                                                src="images/invest/bod-img7.webp"
                                                                class="img-responsive" alt="">
                                                            <div class="nameData">
                                                                <h3>Puneet Yadu Dalmia</h3>
                                                                <p>Independent Director</p>
                                                            </div>
                                                            <div class="btmDiv"></div>
                                                        </div>
                                                        <div class="swiper-slide"><img
                                                                src="images/invest/bod-img8.webp"
                                                                class="img-responsive" alt="">
                                                            <div class="nameData">
                                                                <h3>Yash Gupta</h3>
                                                                <p>Independent Director</p>
                                                        ...
                                                        <div class="swiper-slide"><img
                                                                src="images/invest/bod-img9.webp"
                                                                class="img-responsive" alt="">
                                                            <div class="nameData">
                                                                <h3>Raj Kumar Jain</h3>
                                                                <p>Independent Director</p>
                                                            </div>
                                                            <div class="btmDiv"></div>
                                                        </div>
                                                        <div class="swiper-slide"><img
                                                                src="images/invest/bod-img10.webp"
                                                                class="img-responsive" alt="">
                                                            <div class="nameData">
                                                                <h3>Pramod Gopaldas Gujarathi</h3>
                                                                <p>Independent Director</p>
                                                            </div>
                                                            <div class="btmDiv"></div>
                                                        </div>
                                        ...
                                        <div class="childSec">
                                            ...
                                            <div class="committee-list">
                                                <div class="committee-item"><span
                                                    class="dot audit"></span>Audit Committee</div>
                                                <div class="committee-item"><span
                                                ...
                                                <div class="committee-item"><span
                                                    class="dot risk"></span>Risk Management Committee
                                                </div>
                                            </div>
                                            </div>
                                        </div>
